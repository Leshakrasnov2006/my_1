...
$services = [
    [
        ...
        'description' => 'Профессиональные сайты для бизнеса с акцентом на имидж и функциональность.'
    ],
    [
        'title' => 'Интернет-магазины',
        'description' => 'Полноценные онлайн-магазины с интеграцией платежных систем и CRM.'
    ],
    [
        'title' => 'Лендинг-пейдж',
        'description' => 'Высококонверсионные посадочные страницы для продвижения продуктов и услуг.'
    ],
    [
        'title' => 'Веб-сервисы',
        'description' => 'Разработка кастомных веб-приложений под конкретные бизнес-задачи.'
    ]
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?= $company['name'] ?> - Услуги</title>
    <style>
